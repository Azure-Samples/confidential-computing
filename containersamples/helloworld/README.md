...
You can use this yaml file for your Azure Kubernetes Service deployment. There is one pod, oe-helloworld, which can be deployed by using [helloworld/helloworld.yaml](helloworld.yaml).
